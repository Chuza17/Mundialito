...
alter table public.match_score_predictions
  ...
  check (points_awarded is null or points_awarded between 0 and 2);

comment on constraint match_score_predictions_points_awarded_range on public.match_score_predictions is
  'Match score predictions award 2 points for exact score, 1 point for correct winner, and 0 otherwise.';
