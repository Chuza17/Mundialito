...
export const FALLBACK_MATCHES = [
  ...
  { match_code: 'R32_02', round: ROUNDS.ROUND_OF_32, display_name: 'Partido 74', home_source_type: 'group_position', home_source_group: 'E', home_source_position: 1, away_source_type: 'best_third', away_third_options: ['A', 'B', 'C', 'D', 'F'] },
  ...
  { match_code: 'R32_04', round: ROUNDS.ROUND_OF_32, display_name: 'Partido 76', home_source_type: 'group_position', home_source_group: 'C', home_source_position: 1, away_source_type: 'group_position', away_source_group: 'F', away_source_position: 2 },
  ...
  { match_code: 'R32_12', round: ROUNDS.ROUND_OF_32, display_name: 'Partido 84', home_source_type: 'group_position', home_source_group: 'H', home_source_position: 1, away_source_type: 'group_position', away_source_group: 'J', away_source_position: 2 },
  { match_code: 'R32_13', round: ROUNDS.ROUND_OF_32, display_name: 'Partido 85', home_source_type: 'group_position', home_source_group: 'B', home_source_position: 1, away_source_type: 'best_third', away_third_options: ['E', 'F', 'G', 'I', 'J'] },
  { match_code: 'R32_14', round: ROUNDS.ROUND_OF_32, display_name: 'Partido 86', home_source_type: 'group_position', home_source_group: 'J', home_source_position: 1, away_source_type: 'group_position', away_source_group: 'H', away_source_position: 2 },
  { match_code: 'R32_15', round: ROUNDS.ROUND_OF_32, display_name: 'Partido 87', home_source_type: 'group_position', home_source_group: 'K', home_source_position: 1, away_source_type: 'best_third', away_third_options: ['D', 'E', 'I', 'J', 'L'] },
  { match_code: 'R32_16', round: ROUNDS.ROUND_OF_32, display_name: 'Partido 88', home_source_type: 'group_position', home_source_group: 'D', home_source_position: 2, away_source_type: 'group_position', away_source_group: 'G', away_source_position: 2 },
  { match_code: 'R16_01', round: ROUNDS.ROUND_OF_16, display_name: 'Partido 89', home_source_type: 'match_winner', home_source_match: 'R32_02', away_source_type: 'match_winner', away_source_match: 'R32_05' },
  { match_code: 'R16_02', round: ROUNDS.ROUND_OF_16, display_name: 'Partido 90', home_source_type: 'match_winner', home_source_match: 'R32_01', away_source_type: 'match_winner', away_source_match: 'R32_03' },
  { match_code: 'R16_03', round: ROUNDS.ROUND_OF_16, display_name: 'Partido 91', home_source_type: 'match_winner', home_source_match: 'R32_04', away_source_type: 'match_winner', away_source_match: 'R32_06' },
  { match_code: 'R16_04', round: ROUNDS.ROUND_OF_16, display_name: 'Partido 92', home_source_type: 'match_winner', home_source_match: 'R32_07', away_source_type: 'match_winner', away_source_match: 'R32_08' },
  { match_code: 'R16_05', round: ROUNDS.ROUND_OF_16, display_name: 'Partido 93', home_source_type: 'match_winner', home_source_match: 'R32_11', away_source_type: 'match_winner', away_source_match: 'R32_12' },
  { match_code: 'R16_06', round: ROUNDS.ROUND_OF_16, display_name: 'Partido 94', home_source_type: 'match_winner', home_source_match: 'R32_09', away_source_type: 'match_winner', away_source_match: 'R32_10' },
  { match_code: 'R16_07', round: ROUNDS.ROUND_OF_16, display_name: 'Partido 95', home_source_type: 'match_winner', home_source_match: 'R32_14', away_source_type: 'match_winner', away_source_match: 'R32_16' },
  { match_code: 'R16_08', round: ROUNDS.ROUND_OF_16, display_name: 'Partido 96', home_source_type: 'match_winner', home_source_match: 'R32_13', away_source_type: 'match_winner', away_source_match: 'R32_15' },
  { match_code: 'QF_01', round: ROUNDS.QUARTER_FINALS, display_name: 'Partido 97', home_source_type: 'match_winner', home_source_match: 'R16_01', away_source_type: 'match_winner', away_source_match: 'R16_02' },
  { match_code: 'QF_02', round: ROUNDS.QUARTER_FINALS, display_name: 'Partido 98', home_source_type: 'match_winner', home_source_match: 'R16_05', away_source_type: 'match_winner', away_source_match: 'R16_06' },
  { match_code: 'QF_03', round: ROUNDS.QUARTER_FINALS, display_name: 'Partido 99', home_source_type: 'match_winner', home_source_match: 'R16_03', away_source_type: 'match_winner', away_source_match: 'R16_04' },
  { match_code: 'QF_04', round: ROUNDS.QUARTER_FINALS, display_name: 'Partido 100', home_source_type: 'match_winner', home_source_match: 'R16_07', away_source_type: 'match_winner', away_source_match: 'R16_08' },
  { match_code: 'SF_01', round: ROUNDS.SEMI_FINALS, display_name: 'Partido 101', home_source_type: 'match_winner', home_source_match: 'QF_01', away_source_type: 'match_winner', away_source_match: 'QF_02' },
  { match_code: 'SF_02', round: ROUNDS.SEMI_FINALS, display_name: 'Partido 102', home_source_type: 'match_winner', home_source_match: 'QF_03', away_source_type: 'match_winner', away_source_match: 'QF_04' },
  { match_code: 'FIN_01', round: ROUNDS.FINAL, display_name: 'Partido 104', home_source_type: 'match_winner', home_source_match: 'SF_01', away_source_type: 'match_winner', away_source_match: 'SF_02' },
]
